...
Shader "N3DS/Specular/Vertex RimLit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOut vert(VertexIn i)
			{
				...
				float3 worldNormal = normalize(mul((float3x3)unity_WorldToObject, i.normal));
				...
				o.color = clamp(diffuse, 0, 1) + _SpecColor * specularStrength;
