...
Shader "N3DS/Terrain/Lightmap/3-Layer" {
	Properties {
		...
		_TerrainTex3 ("Base (Mask 2)", 2D) = "white" {}
	...
	SubShader {
		...
		Pass {
			...
			v2f vert_surf (Input IN)
			{
				...
				#ifdef SUPPORT_TILING
				o.texcoord0 = TRANSFORM_TEX(IN.texcoord.xy, _MaskTex1);
				o.texcoord1 = TRANSFORM_TEX(IN.texcoord.xy, _MaskTex2);
				o.texcoord2 = TRANSFORM_TEX(IN.texcoord.xy, _TerrainTex1);
				o.texcoord3 = TRANSFORM_TEX(IN.texcoord.xy, _TerrainTex2);
				o.texcoord4 = TRANSFORM_TEX(IN.texcoord.xy, _TerrainTex3);
				#else
				o.texcoord0 = IN.texcoord.xy;
				o.texcoord1 = IN.texcoord.xy;
				o.texcoord2 = IN.texcoord.xy;
				o.texcoord3 = IN.texcoord.xy;
				o.texcoord4 = IN.texcoord.xy;
				#endif
				return o;
			}
			...
			{
				fixed4 mask1 = tex2D(_MaskTex1, IN.texcoord0);
				fixed4 mask2 = tex2D(_MaskTex2, IN.texcoord1);
				fixed4 col1 = tex2D(_TerrainTex1, IN.texcoord2) * IN.color;
				fixed4 col2 = tex2D(_TerrainTex2, IN.texcoord3) * IN.color * mask1.a;
				fixed4 col3 = tex2D(_TerrainTex3, IN.texcoord4) * IN.color * mask2.a;
